...
classifier.addExample('Este restaurante es bastante promedio en términos de comida y servicio', 'neutro');
classifier.addExample('La ferretería tiene los productos que necesito, sin más', 'neutro');
classifier.addExample('Probé algunas paletas en esa paletería, no estaban mal', 'neutro');
classifier.addExample('La botana en este lugar es normal, nada especial', 'neutro');
classifier.addExample('La tienda de ropa tiene ropa de moda, pero los precios son altos', 'neutro');
classifier.addExample('Este café es adecuado para tomar un rápido café', 'neutro');
classifier.addExample('No tengo opiniones fuertes sobre los productos electrónicos de esta tienda', 'neutro');
classifier.addExample('El bar tiene un ambiente típico de un bar', 'neutro');
classifier.addExample('La librería tiene una selección variada de libros', 'neutro');
classifier.addExample('Probé algunos helados en esa heladería, estaban bien', 'neutro');
...
classifier.addExample('La comida en este restaurante es increíble', 'positivo');
classifier.addExample('El servicio en esta ferretería es excepcional', 'positivo');
classifier.addExample('Las paletas en esta paletería son deliciosas', 'positivo');
classifier.addExample('Me encanta este lugar de botanas, siempre tienen opciones deliciosas', 'positivo');
classifier.addExample('El personal de esta tienda de ropa es amable y servicial', 'positivo');
classifier.addExample('Este café tiene un ambiente acogedor y relajante', 'positivo');
classifier.addExample('Los productos de esta tienda de electrónicos son de alta calidad', 'positivo');
classifier.addExample('El ambiente en este bar es genial para pasar la noche', 'positivo');
classifier.addExample('Esta librería tiene una amplia selección de libros interesantes', 'positivo');
classifier.addExample('Los helados de esta heladería son un verdadero placer', 'positivo');
...
classifier.addExample('La comida en este restaurante es terrible', 'negativo');
classifier.addExample('El servicio en esta ferretería es pésimo', 'negativo');
classifier.addExample('Las paletas en esta paletería son de mala calidad', 'negativo');
classifier.addExample('No vuelvo a este lugar de botanas, la comida es horrible', 'negativo');
classifier.addExample('El personal de esta tienda de ropa es grosero y poco servicial', 'negativo');
classifier.addExample('Este café tiene un ambiente incómodo y sucio', 'negativo');
classifier.addExample('Los productos de esta tienda de electrónicos son de baja calidad', 'negativo');
classifier.addExample('El ambiente en este bar es ruidoso y desagradable', 'negativo');
classifier.addExample('Esta librería tiene una selección de libros aburridos', 'negativo');
classifier.addExample('Los helados de esta heladería saben mal', 'negativo');
